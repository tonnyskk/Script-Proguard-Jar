...
public class AmazonSharedPreferencesWrapper {
    ...
    /**
     * Set all of the Shared Preferences used by the Token Vending Machine to null. This function is useful if the user needs/wants to log out to clear any user specific information.
     */
    ...
    /**
     * Stores the UID and Key that were registered in the Shared Preferences. The UID and Key and used to encrypt/decrypt the Token that is returned from the Token Vending Machine.
     */
    ...
    /**
     * Checks if the current Token's expiration date stored in Shared Preferences has expired. A token that has expired or will expire in fifteen minutes or less is considered expired.
     */
